...
const FriendsCard = () => {
    ...
    const filterFriends = (friends: userType[], cSearch: string) => {
        if (friends) return friends.filter((t) => t.name.toLocaleLowerCase().includes(cSearch.toLocaleLowerCase()));

        return friends;
    };
    const [search, setSearch] = React.useState('');
    const getFriends = useSelector((state) => filterFriends(state.userpostsReducer.followers, search));
