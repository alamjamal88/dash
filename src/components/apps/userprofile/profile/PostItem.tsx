            ...
            <Box p={3}>
                <Stack direction={'row'} gap={2} alignItems="center">
                    ...
                    <Typography variant="caption" color="textSecondary">
                        <IconCircle size="7" fill="" fillOpacity={'0.1'} strokeOpacity="0.1" /> {post?.profile.time}
                    </Typography>
                </Stack>
                {/**Post Content**/}
                            ...
                            {post?.data.images.map((photo) => {
                                return (
                                    ...
                                    >
                                        <CardMedia
                                            component="img"
                                            sx={{ borderRadius: (customizer.borderRadius ?? 8) / 4, height: 360 }}
                                            image={photo.img}
                                            alt="cover"
                                            width={'100%'}
                                        />
                ...
                {post?.data.video ? (
                    <CardMedia
                        sx={{
                            borderRadius: (customizer.borderRadius ?? 8) / 4,
                            height: 300,
                            mb: 2
                        }}
                        component="iframe"
