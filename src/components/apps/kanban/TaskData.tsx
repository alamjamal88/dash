...
import { Box, Chip, IconButton, ListItemIcon, ListItemText, Stack, Typography } from '@mui/material';
...
const TaskData: React.FC<TaskDataProps> = ({ task, onDeleteTask, index }: any) => {
    ...
    return (
        <Draggable draggableId={task.id} index={index}>
            {(provided: any) => (
                <Box mb={3} {...provided.draggableProps} {...provided.dragHandleProps} ref={provided.innerRef}>
                    <BlankCard>
