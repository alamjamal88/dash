...
const EditInvoicePage = () => {
    ...
    const handleOrderChange = (index: string | number | any, field: string, value: string | number) => {
        ...
        if (field === 'unitPrice' || field === 'units') {
            updatedOrders[index].unitTotalPrice = updatedOrders[index].unitPrice * updatedOrders[index].units;
        }
        ...
        const updatedInvoice = {
            ...
            grandTotal: calculateGrandTotal(calculateTotalCost(updatedOrders), calculateVAT(updatedOrders))
        };
