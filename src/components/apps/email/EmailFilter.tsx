...
import { ListItemText, ListItemButton, List, Divider, ListItemIcon, Box, Typography } from '@mui/material';
                ...
                <Scrollbar sx={{ height: { lg: 'calc(100vh - 100px)', md: '100vh' }, maxHeight: '800px' }}>
                    {filterData.map((filter) => {
                        if (filter.filterbyTitle) {
                            return (
                                <Typography variant="subtitle2" p={3} pb={1} pl={5.5} fontWeight={600} key={filter.id}>
