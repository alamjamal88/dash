...
import { currentUser } from 'src/store/auth/AuthSlice';
import { getAllUserData } from 'src/store/user/UserSlice';
...
const RevenueUpdates = () => {
    ...
    const clickReport = async (e: React.MouseEvent<HTMLButtonElement>) => {
        e.preventDefault();
        console.log('report');
        ...
        >
            <Grid container spacing={3}>
                ...
                >
                    ...
                    <Button color="primary" variant="contained" fullWidth onClick={clickReport}>
                        View Full Report
                    </Button>
                </Grid>
            </Grid>
