            ...
            <div>
                ...
                >
                    <NavLink to="https://modernize-react.adminmart.com/dashboards/modern">
                        <img src={Demo1} alt="user-img" width={380} height={300} style={{ borderRadius: '16px' }} />
                    </NavLink>
                </Box>
            </div>
            <div>
                ...
                >
                    <NavLink to="https://modernize-react-dark.netlify.app/dashboards/ecommerce">
                        <img src={Demo2} alt="user-img" width={380} height={300} style={{ borderRadius: '16px' }} />
                    </NavLink>
                </Box>
            </div>
            <div>
                ...
                >
                    <NavLink to="https://modernize-react-rtl.netlify.app/dashboards/modern">
                        <img src={Demo3} alt="user-img" width={380} height={300} style={{ borderRadius: '16px' }} />
                    </NavLink>
                </Box>
            </div>
            <div>
                ...
                >
                    <NavLink to="https://modernize-react-horizontal.netlify.app/dashboards/modern">
                        <img src={Demo4} alt="user-img" width={380} height={300} style={{ borderRadius: '16px' }} />
                    </NavLink>
                </Box>
            </div>
            <div>
                ...
                >
                    <NavLink to="https://modernize-react.adminmart.com/apps/chats">
                        <img src={App1} alt="user-img" width={380} height={300} style={{ borderRadius: '16px' }} />
                    </NavLink>
                </Box>
            </div>
            <div>
                ...
                >
                    <NavLink to="https://modernize-react.adminmart.com/apps/email">
                        <img src={App2} alt="user-img" width={380} height={300} style={{ borderRadius: '16px' }} />
                    </NavLink>
                </Box>
            </div>
        </Slider>
