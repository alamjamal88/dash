...
import { Box, Stepper, Step, StepLabel, Button, Typography, FormControlLabel, Alert, Stack } from '@mui/material';
                ...
                return (
                    <Box pt={3}>
                        ...
                        <Typography variant="body2" sx={{ mt: 1 }}>
                            Sard about this site or you have been to it, but you cannot figure out what it is or what it
                            can do. MTA web directory isSard about this site or you have been to it, but you cannot
