...
import { CardContent, Button, Dialog, DialogActions, DialogContent, Fab, TextField, Typography } from '@mui/material';
...
const BigCalendar = () => {
    ...
    const editEvent = (event: any) => {
        const newEditEvent = calevents.find((elem: any) => elem.title === event.title);
