    ...
    return (
        <PageContainer title="Pricing" description="this is Pricing page">
            ...
            <Grid container spacing={3} justifyContent="center" mt={3}>
                ...
                >
                    <Typography variant="h2">Flexible Plans Tailored to Fit Your Community's Unique Needs!</Typography>
                    ...
                    >
                        <BlankCard>
                            <CardContent sx={{ p: '30px' }}>
                                ...
                                <Button sx={{ width: '100%', mt: 3 }} variant="contained" size="large" color="primary">
                                    {price.btntext}
                                </Button>
                            </CardContent>
                        </BlankCard>
